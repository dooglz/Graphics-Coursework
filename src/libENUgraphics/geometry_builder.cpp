...
void geometry_builder::create_plane_r(const unsigned int width, const unsigned int depth,
...
geometry geometry_builder::create_plane(const unsigned int width, const unsigned int depth, const bool uvscale) {
  // Type of geometry generated will be triangles
  geometry geom;
  geom.set_type(GL_TRIANGLES);
