...
public:
  ...
  static void bind(const std::vector<directional_light> &directionals, const std::string &name, const unsigned int MaxLights = 0) throw(...);
  static void bind(const std::vector<directional_light*> &directionals, const std::string &name, const unsigned int MaxLights = 0) throw(...);
  ...
  static void bind(const std::vector<point_light> &points, const std::string &name, const unsigned int MaxLights = 0) throw(...);
  static void bind(const std::vector<point_light*> &points, const std::string &name, const unsigned int MaxLights = 0) throw(...);
  ...
  static void bind(const std::vector<spot_light> &spots, const std::string &name, const unsigned int MaxLights = 0) throw(...);
  static void bind(const std::vector<spot_light*> &spots, const std::string &name, const unsigned int MaxLights = 0) throw(...);
