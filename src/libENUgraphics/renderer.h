...
public:
  ...
  static void bind(const directional_light &light,
                   const std::string &name) throw(...);
  // Binds a point light with the renderer
  static void bind(const point_light &point,
                   const std::string &name) throw(...);
  // Binds a vector of point lights to the renderer
  static void bind(const std::vector<point_light> &points,
                   const std::string &name) throw(...);
  ...
  static void bind(const std::vector<spot_light> &spots,
                   const std::string &name) throw(...);
